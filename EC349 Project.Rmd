...
Additionally, similar projects employed F1 score as an evaluation metric, accounting for Type I and Type II errors, along with confusion matrix [@liu2020; @liuz2020; @asghar2016]. Also, in terms of text pre-processing, the td-idf transformer or vectorizer was used to generate weight of each word, as the length of the text may affect the count for "buzzwords" [@elkouri2015; @asghar2016; @a.rafay2020; @liu2020; @liuz2020]. Regrettably, these are not implemented in this data project, as it would be computationally challenging and beyond the learning scope.
...
*(Sorry about the overlapping text. The table can be found in [Regression Coefficient](https://github.com/nay-iaw/EC349-Project/blob/master/regression_coefficients.csv))*
